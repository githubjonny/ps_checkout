              ...
              <b-col sm="6" md="6" lg="6">
                ...
                >
                  <b-form-input
                    ...
                    :class="[
                      form.business_contact_first_name !== ''
                        ? ''
                        : 'has-danger'
                    ]"
                  />
              ...
              <b-col sm="6" md="6" lg="6">
                ...
                >
                  <b-form-input
                    ...
                    :class="[
                      form.business_contact_last_name !== '' ? '' : 'has-danger'
                    ]"
                  />
                </b-form-group>
              </b-col>
              ...
              <b-col sm="6" md="6" lg="6">
                ...
                >
                  <b-form-select
                    ...
                    :class="[
                      form.business_contact_language !== '' ? '' : 'has-danger'
                    ]"
                  >
                    <option
              ...
              <b-col sm="12" md="12" lg="12">
                ...
                >
                  <b-form-input
                    ...
                    :class="[
                      form.business_address_street !== '' ? '' : 'has-danger'
                    ]"
                  />
                </b-form-group>
              </b-col>
              ...
              <b-col sm="6" md="6" lg="6">
                ...
                >
                  <b-form-input
                    ...
                    :class="[
                      form.business_address_zip !== '' ? '' : 'has-danger'
                    ]"
                  />
                </b-form-group>
              </b-col>
              <b-col sm="6" md="6" lg="6">
                ...
                >
                  <b-form-input
                    ...
                    :class="[
                      form.business_address_city !== '' ? '' : 'has-danger'
                    ]"
                  />
                </b-form-group>
              </b-col>
